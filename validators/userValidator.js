...
let validationResult=require('../middlewares/validationMiddleware');
...
let updateLoggedUserValidator= [
    ...
    isLength({min:5,max:12}).withMessage('username length must be between 3,12').custom((val,{req})=>{
...
module.exports={
    ...
    createUserValidator,
    changeLoggedUserPasswordValidator,deleteUserValidator};